...
namespace BTL___Nhóm_1
{
    ...
    {
        SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-WICKY\SQLEXPRESS01;Initial Catalog=DeCuong;Integrated Security=True;Encrypt=True;TrustServerCertificate=True");
        String user;
